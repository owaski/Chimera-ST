...
from fairseq.data.audio.multilingual_triplet_v2_ctc_dataset import (
...
@register_task("multilingual_triplet_ctc_task")
class MultilingualTripletCTCTask(LegacyFairseqTask):
    @staticmethod
    def add_args(parser):
