...
from fairseq.data.audio.multilingual_triplet_align_cluster_v2_dataset import (
...
@register_task("multilingual_triplet_align_cluster_v2_task")
class MultilingualTripletAlignClusterV2Task(LegacyFairseqTask):
    @staticmethod
    def add_args(parser):
