...
from fairseq.data.audio.multilingual_triplet_align_cluster_dataset import (
...
@register_task("multilingual_triplet_align_cluster_task")
class MultilingualTripletAlignClusterTask(LegacyFairseqTask):
    @staticmethod
    def add_args(parser):
