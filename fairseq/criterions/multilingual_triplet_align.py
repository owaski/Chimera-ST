...
@register_criterion('multilingual_triplet_align_criterion')
class MultilingualTripletAlignCriterion(LabelSmoothedCrossEntropyCriterion):
    def __init__(
        self, 
        task, 
        sentence_avg, 
    ...
    def forward(self, model, sample, reduce=True):
        ...
        if self.loss_ratio[2] > 0 and sample["align_indices"].size(0) > 0:
            ...
            align_loss, align_sample_size = self.compute_align(
        ...
        logging_output = {
            ...
            "align_loss": align_loss.data if self.loss_ratio[2] > 0 else 0,
