...
@register_criterion('multilingual_triplet_align_adv_criterion')
class MultilingualTripletAlignAdvCriterion(LabelSmoothedCrossEntropyCriterion):
    def __init__(
        self, 
        task, 
        sentence_avg, 
    ...
    def forward(self, model, sample, reduce=True):
        ...
        if self.report_accuracy and normal:
