...
clean_df = pd.DataFrame(columns=train_df.columns)
...
for _, row in iterator:
    try:
        ...
        if not flag:
            ...
            iterator.set_description('{} clean'.format(clean_df.shape[0]))
    except:
        pass

save_df_to_tsv(clean_df, os.path.join(mustc_root, 'en-de/train_clean.tsv'))