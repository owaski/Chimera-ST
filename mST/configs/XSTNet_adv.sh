...
fairseq-train $COVOST2_ROOT \
  --task multilingual_triplet_align_adv_v2_task \
  ...
  \
  --criterion multilingual_triplet_align_adv_v2_criterion --label-smoothing 0.1 \
  --report-accuracy --loss-ratio 1.0 1.0 1.0 1.0 0.0 0.0 0.0 --ignore-prefix-size 1 \
  \
