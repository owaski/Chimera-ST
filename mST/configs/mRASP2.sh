...
export train_subset=de_en_train,pt_en_train
export valid_subset=de_en_dev,pt_en_dev

fairseq-train $COVOST2_ROOT \
  --task multilingual_triplet_align_cluster_v2_task \
